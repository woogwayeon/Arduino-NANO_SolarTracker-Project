...
class Ui_MainWindow(QWidget):
    ...
    def update_label(self, data):
        ...
        # 조도센서
        self.label_11.setText(_translate("MainWindow", str(data.get('A0', 0))))
        self.label_10.setText(_translate("MainWindow", str(data.get('A1', 0))))
        self.label_12.setText(_translate("MainWindow", str(data.get('A2', 0))))
        self.label_13.setText(_translate("MainWindow", str(data.get('A3', 0))))
        
        # 볼트표기
        self.label_4.setText(_translate("MainWindow", str(data.get('Volt', 0))))
...
if __name__ == "__main__":
    ...
    ui.pushButton.clicked.connect(ui.stop_serial)
    ui.pushButton_2.clicked.connect(ui.start_serial)
